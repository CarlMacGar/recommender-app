const demoJobs = Array.from({ length: 22 }, (_, i) => ({
  title: `Generic Job Title ${i + 1}`,
  job_id: i + 1,
  job_description:
  ...
  similarity_hybrid: 0.9 - (i % 5) * 0.01,
  similarity_content: 0.88 - (i % 4) * 0.01,
  similarity_context: 0.85 - (i % 3) * 0.01,
  similarity_knn: 0.82 - (i % 2) * 0.01,
  job_posting_url: "https://co.linkedin.com/",
